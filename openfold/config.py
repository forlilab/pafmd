...
def model_config(
    ...
    if name == "initial_training":
        ...
        pass
    elif "rw_finetuning" in name and "multimer" not in name:
        #this is used for gradient descent phase of randomwalk pipeline
        c.data.rw_finetuning.max_extra_msa = 1024
        ...
        c.rw_finetuning = mlc.ConfigDict()
        c.rw_finetuning.ft_method = ft_method
    ...
    elif "conformation_finetuning" in name and "multimer" not in name:
        c.data.conformation_finetuning.max_extra_msa = 1024
        c.data.predict.max_extra_msa = 1024 
        c.data.common.reduce_max_clusters_by_max_templates = True
        c.data.common.use_templates = True
        c.data.common.use_template_torsion_angles = True
        ...
        c.model.heads.tm.enabled = True
        c.data.data_module.data_loaders.num_workers = 4
    ...
    # INFERENCE PRESETS
        ...
        if 'rw_finetuning' in name:
            ...
            c.rw_finetuning = mlc.ConfigDict()
            c.rw_finetuning.loss_type = loss_type
            c.rw_finetuning.ft_method = ft_method
            c.rw_finetuning.model_name = model_name
            c.data.data_module.data_loaders.num_workers = 1
...
config = mlc.ConfigDict(
    {
        "data": {
            ...
            "rw_finetuning": { #same as predict except for supervised 
                "fixed_size": True,
                "subsample_templates": False,  # We want top templates.
                "block_delete_msa": False,
                "masked_msa_replace_fraction": 0.15,
            ...
            "conformation_finetuning": { #same as predict except for supervised 
                "fixed_size": True,
                "subsample_templates": False,  # We want top templates.
                "block_delete_msa": False,
                "masked_msa_replace_fraction": 0.15,
