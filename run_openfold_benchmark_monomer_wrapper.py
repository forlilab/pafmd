...
def gen_args(alignment_dir, output_dir_base, openfold_weights_dir, af_weights_dir, template_mmcif_dir, use_templates, use_af_weights, msa_mask_fraction, num_predictions_per_model, overwrite_pred):
...
if __name__ == "__main__":
    ...
    supp_parser.add_argument(
        "--num_predictions_per_model", type=int, default=100
    )
    supp_parser.add_argument(
        "--overwrite_pred", action="store_true", default=False
    )
