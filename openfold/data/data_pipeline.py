...
def make_mmcif_features(
    mmcif_object: mmcif_parsing.MmcifObject, chain_id: str, residues_ignore_idx: Tuple[int] = None
) -> FeatureDict:
    ...
    all_atom_positions, all_atom_mask = mmcif_parsing.get_atom_coords(
        mmcif_object=mmcif_object, chain_id=chain_id, residues_ignore_idx=residues_ignore_idx
    )
...
class DataPipeline:
    ...
    def process_mmcif(
        ...
        mmcif_feats = make_mmcif_features(mmcif, chain_id, residues_ignore_idx)
